...
# Package-Metadata
NAME = "catopuma"
DESCRIPTION = '2D Unet for Silent Cerebral Infarct segmentation'
URL = 'https://github.com/RiccardoBiondi/SCI-segmentator'
EMAIL = 'riccardo.biondi7@unibo.it'
AUTHOR = 'Riccardo Biondi'
VERSION = None
KEYWORDS = 'artificial-intelligence deep-learning image-segmentation silent-cerebral-infarction tensorflow keras pytorch'
...
setup(
    ...
    download_url=URL,
    keywords=KEYWORDS,
    packages=find_packages(include=['sci_segmentator'], exclude=('test')),
